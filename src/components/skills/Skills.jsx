          ...
          <div className="left flex-1 w-full">
            ...
            >
              <div className=" flex flex-col gap-6  w-3/4  my-5 md:w-[90%]">
                <ProgressBar logo={<SiPython />} name={"PYTHON"} value={70} />
                <ProgressBar logo={<IoLogoHtml5 />} name={"HTML"} value={65} />
                <ProgressBar logo={<IoLogoCss3 />} name={"CSS"} value={58} />
                <ProgressBar logo={<SiJavascript />} name={"Javascript"} value={60}/>
                <ProgressBar logo={<FaReact />} name={"React Js"} value={25} />
                <ProgressBar logo={<SiTailwindcss />} name={"Tailwind CSS"} value={25}/>
              </div>
            </div>
          </div>
          {/* right box */}
